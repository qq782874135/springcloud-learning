...
@Configuration
@MapperScan(basePackages = "com.zsfs.timer.job.springcloudtimer.mapper.sqlserver", sqlSessionFactoryRef = "otherSqlSessionFactory")
public class DBConfigForSqlServer {
